...
pub async fn run_cycle(token: &str, vault_address: &str, keystore_path: &str, slippage_bps: u16, dry_run: bool, debug: bool) -> ErrStr<()> {
    ...
    let reference_quote = kyber_swap(&registry, UNDEAD, token, reference_amount).await?.amount_out;
...
///========================================================================================
#[derive(Debug, Parser)]
#[command(name = "equalizer")]
#[command(bin_name = "c_equalizer")]
...
pub mod functional_tests {
    ...
    create_testing!("quiz01::c_equalizer");
