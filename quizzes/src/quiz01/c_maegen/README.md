...
`$ maegen [--dry-run] [--debug] [--slippage-bps <bps>] <TOKEN>`
...
> _This is subject to change, as `maegen` may reiceve its own env-vars_
> some reason for this this: 
> just trying to achieve the simplest form of `maegen` first.
